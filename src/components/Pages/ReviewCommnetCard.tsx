        ...
        <div className="card-body p-lg-4 p-3">
          <div className="d-flex mb-3 pb-3 border-bottom flex-wrap">
            ...
            <div className="flex-fill ms-3 text-truncate">
              <h6 className="mb-0">
                ...
                <span className="text-muted small">1050 Followers</span>
              </h6>
          ...
          <div className="timeline-item-post">
            ...
            <div className="mb-2 mt-4 text-end">
              <a className="me-lg-2 me-1 btn btn-primary btn-sm" href="#!">
                <i className="fa fa-thumbs-up"></i>{" "}
                <span className="d-none d-sm-none d-md-inline">Like (105)</span>
              </a>
              <a className="me-lg-2 me-1 btn btn-primary btn-sm" href="#!">
          ...
          <div className="d-flex mb-3 pb-3 border-bottom flex-wrap">
            ...
            <div className="flex-fill ms-3 text-truncate">
              <h6 className="mb-0">
                ...
                <span className="text-muted small">650 Followers</span>
              </h6>
          ...
          <div className="d-flex mb-3 pb-3 border-bottom flex-wrap">
            ...
            <div className="flex-fill ms-3 text-truncate">
              <h6 className="mb-0">
                ...
                <span className="text-muted small">458 Followers</span>
              </h6>
...
export default ReviewCommnetCard;
