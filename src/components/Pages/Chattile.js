          ...
          <div className="tab-content border-top">
            ...
            >
              <ul className="list-unstyled list-group list-group-custom list-group-flush mb-0">
                {chatData.map((d: any, i: number) => {
                  return (
                    <li
                      key={"545" + i}
                      className={`list-group-item px-md-4 py-3 py-md-4 ${activeChatIndex ===
                      i
                        ? "open"
                        : ""}`}
                    >
                      <a
                        ...
                        onClick={e => {
                          e.preventDefault();
                          this.setState({ activeChatIndex: i });
                        }}
                      >
                        <img
                  ...
                  <a href="#!" className="d-flex">
                    ...
                    <div className="flex-fill ms-3 text-truncate">
                      <div className="d-flex justify-content-between mb-0">
                        ...
                        <div className="text-muted">
                          <i className="fa fa-heart-o ps-2" />
                          <i className="fa fa-trash ps-2" />
                        </div>
                      </div>
                      <span className="text-muted">
                        barbara.kelly@mytask.com
                      </span>
                    </div>
                  </a>
                </li>
        ...
        <div className="card card-chat-body border-0 order-1 w-100 px-4 px-md-5 py-3 py-md-4">
          ...
          >
            {chatData[activeChatIndex].messages.map((data, i) => {
              return (
                ...
                >
                  <div
                    className={`max-width-70 ${data.type === "received"
                      ? ""
                      : "text-end"}`}
                  >
                    ...
                    <div
                      className={`card border-0 p-3 ${data.type === "received"
                        ? ""
                        : "color-bg-100 text-light"}`}
                    >
          ...
          <div className="chat-message">
            <textarea
              ...
              onChange={e => {
                this.onChangeMessageText(e.target.value);
              }}
            />
            <button
              className="btn btn-dark"
              type="button"
              onClick={this.onMessgeSend}
            >
              Send
            </button>
          </div>
