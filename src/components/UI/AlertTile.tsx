...
type IState = { dismissibleAlert: boolean };
const INITIAL_STATE: IState = { dismissibleAlert: true };

const AlertTile: React.FC = () => {
  const [state, setState] = useState<IState>(INITIAL_STATE);
  const { dismissibleAlert } = state;
...
<Alert variant='dark'>This is a dark alert—check it out!</Alert>`}
        ...
        <div className="bd-callout bd-callout-info">
          ...
          <p>
            ...
            hidden with the <code>.visually-hidden</code> class.
          </p>
        </div>
...
<p className="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.</p>
        ...
        <ul>
          ...
          <li>
            On the close button, add the <code>data-dismiss="alert"</code>{" "}
        ...
        <div className="bd-example mb-5">
          ...
          >
            ...
            <button
              ...
              aria-label="Close"
              onClick={() => {
                setState({ dismissibleAlert: false });
              }}
            ></button>
          </Alert>
          <SyntaxHighlighter
            ...
            className="language-html"
          >
            {`<Alert variant='warning' show={dismissibleAlert} onClose={() =>{ this.setState({ dismissibleAlert:false }) }} dismissible>
...
<button type="button" className="btn-close" data-dismiss="alert" aria-label="Close"></button>
        ...
        <div className="card p-3 mb-3">
          When an alert is dismissed, the element is completely removed from the
          page structure. If a keyboard user dismisses the alert using the close
          button, their focus will suddenly be lost and, depending on the
          browser, reset to the start of the page/document. For this reason, we
          recommend including additional JavaScript that listens for the{" "}
          <code>closed.bs.alert</code> event and programmatically sets{" "}
          <code>focus()</code> to the most appropriate location in the page. If
          you’re planning to move focus to a non-interactive element that
          normally does not receive focus, make sure to add{" "}
          <code>tabindex="-1"</code> to the element.
        </div>

        <h2 id="javascript-behavior" className="mb-5 mt-5">
          JavaScript behavior
        </h2>
...
new bootstrap.Alert(alert)
        ...
        <p>
          Or with <code>data</code> attributes on a button{" "}
          <strong>within the alert</strong>, as demonstrated above:
        </p>
        <div className="bd-example mb-5">
          <SyntaxHighlighter
            language="javascript"
        ...
        <p>
          You can create an alert instance with the alert constructor, for
          example:
        </p>
        <div className="bd-example mb-5">
          <SyntaxHighlighter
...
var bsAlert = new bootstrap.Alert(myAlert)`}
        ...
        <p>
          This makes an alert listen for click events on descendant elements
          which have the <code>data-dismiss="alert"</code> attribute. (Not
          necessary when using the data-api’s auto-initialization.)
        </p>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <code>.fade</code> and <code>.show</code> classes are present on
                the element, the alert will fade out before it is removed.
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                ...
                <code>bootstrap.Alert.getInstance(alert)</code>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                Fires immediately when the <code>close</code> instance method is
                called.
              </td>
            </tr>
            <tr>
