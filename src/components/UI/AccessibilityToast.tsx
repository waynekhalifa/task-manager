...
type IState = { basicT: string };
const INITIAL_STATE: IState = { basicT: "Preview" };
  ...
  return (
    <div className="border-top mt-5 pt-3">
      ...
      <p>
        ...
        the user’s focus or otherwise interrupt the user. Additionally, include{" "}
        <code>aria-atomic="true"</code> to ensure that the entire toast is
        always announced as a single (atomic) unit, rather than announcing what
        was changed (which could lead to problems if you only update part of the
        toast’s content, or if displaying the same toast content at a later
        point in time). If the information needed is important for the process,
        e.g. for a list of errors in a form, then use the{" "}
        <a href="https://v5.getbootstrap.com/docs/5.0/components/alerts/">
          alert component
        </a>{" "}
        instead of toast.
      </p>
      <p>
        ...
        <em>before</em> the toast is generated or updated. If you dynamically
        generate both at the same time and inject them into the page, they will
        generally not be announced by assistive technologies.
      </p>
      <p>
        You also need to adapt the <code>role</code> and <code>aria-live</code>{" "}
        level depending on the content. If it’s an important message like an
        error, use <code>role="alert" aria-live="assertive"</code>, otherwise
        use <code>role="status" aria-live="polite"</code> attributes.
      </p>
      <p>
        As the content you’re displaying changes, be sure to update the{" "}
        <a href="#options">
          <code>delay</code> timeout
        </a>{" "}
        to ensure people have enough time to read the toast.
      </p>
      <SyntaxHighlighter
        language="javascript"
        className="mt-2 language-html py-2 px-2"
        style={a11yLight}
      >
    ...
    <div role="alert" aria-live="assertive" aria-atomic="true">...</div>
      ...
      <p>
        When using <code>autohide: false</code>, you must add a close button to
        allow users to dismiss the toast.
      </p>
    ...
    return new bootstrap.Toast(toastEl, option)
      ...
      <div className="card card-callout p-3 mb-4">
        ...
        <p>
          ...
          transition is started but <strong>before it ends</strong>. In
          addition, a method call on a{" "}
          <strong>transitioning component will be ignored</strong>.
        </p>
        <p>
          <a href="https://v5.getbootstrap.com/docs/5.0/getting-started/javascript/#asynchronous-functions-and-transitions">
      ...
      <p>
        ...
        (i.e. before the <code>shown.bs.toast</code> event occurs). You have to
        manually call this method, instead your toast won’t show.
      </p>
      <SyntaxHighlighter
        language="javascript"
        className="mt-2 language-html py-2 px-2"
      ...
      <p>
        ...
        (i.e. before the <code>hidden.bs.toast</code> event occurs). You have to
        manually call this method if you made <code>autohide</code> to{" "}
        <code>false</code>.
      </p>
      <SyntaxHighlighter
        language="javascript"
      ...
      <p>
        Hides an element’s toast. Your toast will remain on the DOM but won’t
        show anymore.
      </p>
      <SyntaxHighlighter
        language="javascript"
      ...
      <table className="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              This event is fired when the toast has been made visible to the
              user.
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              This event is fired when the toast has finished being hidden from
              the user.
            </td>
          </tr>
        </tbody>
