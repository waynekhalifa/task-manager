          ...
          <div className="d-flex">
            ...
            <div className="flex-fill ms-3">
              ...
              <span className="d-flex text-muted align-items-center">
                <i className="icofont-ui-clock me-1"></i> 10 Am
              </span>
            </div>
          </div>
        </div>
        <div className="timeline-item ti-info border-bottom ms-2">
          <div className="d-flex">
            ...
            <div className="flex-fill ms-3">
              ...
              <span className="d-flex text-muted align-items-center">
                <i className="icofont-ui-clock me-1"></i> 11:30 Am
              </span>
            </div>
          </div>
        </div>
        <div className="timeline-item ti-info border-bottom ms-2">
          <div className="d-flex">
            ...
            <div className="flex-fill ms-3">
              ...
              <span className="d-flex text-muted align-items-center">
                <i className="icofont-ui-clock me-1"></i> 1 Pm to 2 Pm
              </span>
            </div>
          </div>
        </div>
        <div className="timeline-item ti-success  border-bottom ms-2">
          <div className="d-flex">
            ...
            <div className="flex-fill ms-3">
              ...
              <span className="d-flex text-muted align-items-center">
                <i className="icofont-ui-clock me-1"></i> 2:10 Pm
              </span>
            </div>
          </div>
        </div>
        <div className="timeline-item ti-info ms-2">
          <div className="d-flex">
            ...
            <div className="flex-fill ms-3">
              ...
              <span className="d-flex text-muted align-items-center">
                <i className="icofont-ui-clock me-1"></i> 7:30 Pm
              </span>
            </div>
          </div>
        </div>
