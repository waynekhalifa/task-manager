        ...
        <div className="row align-items-center">
          ...
          <div className="col-12 col-md-7 col-lg-6 order-md-1 px-4">
            ...
            <p className="line-height-custom">
              ...
              sollicitudin, arcu felis aliquam urna, placerat maximus lorem urna
              commodo sem. Pellentesque venenatis leo quam, sed mattis sapien
              lobortis ut.placerat maximus lorem urna commodo sem
            </p>
            <a
