    ...
    useEffect(() => {
        columnsT = [
            ...
            },
            {
                ...
                selector: () => { },
                sortable: true,
                cell: (row: any) => <span className={`badge ${row.status === "Completed" ? "bg-success" : row.status === "Draf" ? 'bg-lavender-purple' : 'bg-warning'}`}>{row.status}</span>
            },
            {
                name: "ACTION",
                selector: () => { },
                ...
                cell: (row: any) => <div className="btn-group" role="group" aria-label="Basic outlined example">
                    <button type="button" className="btn btn-outline-secondary" onClick={() => setState({ ...state, isModal: true, isEditModalData: row })}><i className="icofont-edit text-success"></i></button>
        ...
        <div className="container-xxl">
            <PageHeader headerTitle="Expenses" renderRight={() => {
                return <div className="col-auto d-flex w-sm-100">
                    ...
                    }}><i className="icofont-plus-circle me-2 fs-6"></i>Add Expenses</button>
                </div>
            }} />
            ...
            <Modal centered show={state.isModal} onHide={() => 
                ...
                <Modal.Body>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="item" onClick={() => { }} value={state.isEditModalData ? state.isEditModalData.item : ""
                        } />
                    </div>
                        ...
                        <form>
                            <div className="row g-3 mb-3">
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="depone" onClick={() => { }} value={
                                        state.isEditModalData ? state.isEditModalData.orderby : ""
                                    } />
                                </div>
                                <div className="col-sm-6">
                                    <label htmlFor="abc" className="form-label">Date</label>
                                    <input type="date" className="form-control" id="abc" onClick={() => { }} value={
                            ...
                            <div className="row g-3 mb-3">
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="deptwo" onClick={() => { }} value={
