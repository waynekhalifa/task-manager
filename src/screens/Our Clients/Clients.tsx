...
const Clients: React.FC<Props> = () => {
  ...
  const { isModal, isModalDelete, modalheader, editModeldata } = state;
  return (
    <div className="container-xxl">
        ...
        renderRight={() => {
          return (
            <div className="col-auto d-flex">
              ...
              >
                <i className="icofont-plus-circle me-2 fs-6" />Add Client
              </button>
            </div>
          );
        }}
          ...
          <div className="modal-body">
            ...
            <div className="mb-3">
              ...
              <input
                ...
                value={editModeldata ? editModeldata.Companyname : ""}
      ...
      <Modal
        ...
        centered
        onHide={() => {
          setState({ ...state, isModalDelete: false });
        }}
      >
        <Modal.Header closeButton>
