...
class Clients extends React.Component{
    ...
    render(){
        const {isModal,isModalDelete,modalheader,editModeldata} = this.state;
        return(
            <div className="container-xxl">
                <PageHeader headerTitle="Clients"
                    renderRight={()=>{
                        return <div className="col-auto d-flex">
                                    ...
                                    <button type="button" className="btn btn-dark ms-1" onClick={()=>{ this.setState({isModal:true,modalheader:'Add Client'}) }}><i className="icofont-plus-circle me-2 fs-6"></i>Add Client</button>
                                </div>
                    }}
                  />
                <div className="row g-3 row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2 row-cols-xxl-2 row-deck py-1 pb-4">
                    {
                        OurClientsData.map((data,i)=>{
                            return <div key={"skhd"+i} className="col">
                                        ...
                                        onClickEdit={()=>{ this.setState({isModal:true,modalheader:'Edit Client',editModeldata:data}) }}
                ...
                <Modal size="xl" centered show={isModal} onHide={()=>{this.setState({isModal:false,editModeldata:""}) }}>
                ...
                <Modal show={isModalDelete} centered onHide={()=>{this.setState({isModalDelete:false}) }}>
                    <Modal.Header closeButton>
                    ...
                    <Modal.Footer>
                        <button type="button" className="btn btn-secondary" onClick={()=>{ this.setState({isModalDelete:false}) }}>Cancel</button>
