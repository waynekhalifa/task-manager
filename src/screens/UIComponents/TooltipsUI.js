...
class TooltipsUI extends React.Component {
    state={
        basicT:"Preview"
    }
  render(){
      const {basicT} = this.state;
      const {activeLayout} = this.props.dashboardReducer;
    return( 
            ...
            <div className="col-12">
                <div className="card p-4 bd-content">
                    ...
                    <div className="alert alert-danger" role="alert">
                        <strong>Tooltips</strong> for more bootstrao components <a href="https://v5.getbootstrap.com/docs/5.0/components/tooltips/" target="_blank" rel="noopener noreferrer">Bootstrap Tooltips documentation <i className="fa fa-external-link"></i></a>
                    </div>
                    <ul>
    ...
    return new bootstrap.Tooltip(tooltipTriggerEl)
                    ...
                    <div className="border-top mt-5 pt-3">
                        ...
                        <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                            <li className="nav-item"><a className={basicT === "Preview"?"nav-link active":"nav-link"} href="#nav-Preview1" onClick={(e)=>{e.preventDefault(); this.setState({ basicT:"Preview" }) }}>Preview</a></li>
                            <li className="nav-item"><a className={basicT === "Html"?"nav-link active":"nav-link"} href="#nav-HTML1" onClick={(e)=>{e.preventDefault(); this.setState({ basicT:"Html" }) }}>HTML</a></li>
                        </ul>
...
export default connect(mapStateToProps, { })(TooltipsUI);