...
class PopoversUI extends React.Component {
  render(){
            ...
            <div className="col-12">
                <div className="card p-4 bd-content">
                    ...
                    <div className="alert alert-danger" role="alert">
                        <strong>Popovers</strong> for more bootstrao components <a href="https://v5.getbootstrap.com/docs/5.0/components/popovers/" target="_blank" rel="noopener noreferrer">Bootstrap Popovers documentation <i className="fa fa-external-link"></i></a>
                    </div>
                    <ul>
