...
class Tasks extends React.Component{
    ...
    render(){
        ...
        return <div className="container-xxl">
            <PageHeader headerTitle="Tasks Management" renderRight={() => {
                return <div className="col-auto d-flex w-sm-100">
                    <button className="btn btn-dark btn-set-task w-sm-100" onClick={() => {
                        this.setState({ isModal: true });
                      }}>
                      <i className="icofont-plus-circle me-2 fs-6" />Create Task
                    </button>
                  </div>;
              }} />
              ...
              <div className="col-lg-12 col-md-12 flex-column">
                ...
                {/* <TaskNestable
                        ...
                        CompletedData={CompletedData}
                         /> */}
                <TaskNestable1 InProgressTaskData={InProgressTaskData} needReviewData={needReviewData} CompletedData={CompletedData} />
              </div>
            </div>
            <Modal show={isModal} onHide={() => {
              ...
              <Modal.Body>
                ...
                <div className="mb-3">
                  ...
                  <input className="form-control" type="file" id="formFileMultipleone" multiple={false} />
                </div>
                ...
                <div className="mb-3">
                  ...
                  <textarea className="form-control" id="exampleFormControlTextarea78" rows="3" placeholder="Add any extra details about the request" />
                </div>
              </Modal.Body>
              <Modal.Footer>
